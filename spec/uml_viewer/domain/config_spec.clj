...
(describe "crap thresholds"
  ...
  (it "leaves a missing score unknown"
...
(describe "crap grade"
  ...
  (it "is unknown when the score is missing"
...
(describe "worst child"
  ...
  (it "keeps a class with no CRAP data unknown"
  ...
  (it "keeps a class with no mutant data unknown"
    (let [good {:killed 9 :survived 1}]
